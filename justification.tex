...
first ever multiply-imaged supernova (SN).}  This program is now feasible 
on HST thanks to the dozens of galaxy clusters that now deep WFC3-IR
imaging on   well-modeled lens models.  Along with the accompanying small GO
